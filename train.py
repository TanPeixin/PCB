...
parser.add_argument('--dataset', type=str, default='cuhk03',
                    choices=['market1501', 'cuhk03', 'duke'])
parser.add_argument('--batch_size', default=32, type=int, help='batch_size') #64
parser.add_argument('--learning_rate', default=0.1, type=float,
                    help='FC params learning rate')
parser.add_argument('--epochs', default=20, type=int,
                    help='The number of epochs to train') #60
    ...
    def train(model, criterion, optimizer, scheduler, dataloader, num_epochs, device):
        ...
        for epoch in range(num_epochs):
            ...
            if (epoch + 1) % 10 == 0 or epoch + 1 == num_epochs:
                ...
                CMC, mAP, _ = test(model, arg.dataset, 256) #512
